...
assert "VERSION traffic 1.4.2" 'grep -q VERSION=\"1.4.2\" "$ROOT/traffic.sh"'
assert "VERSION proxy 1.7.1" 'grep -q VERSION=\"1.7.1\" "$ROOT/proxy.sh"'
assert "VERSION vps 1.3.0" 'grep -q VERSION=\"1.3.0\" "$ROOT/vps.sh"'
